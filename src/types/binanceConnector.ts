...
declare module "@binance/connector" {
  ...
  export class Spot {
    ...
    marginAccount(
      options?: MarginAccountDetailsParameters,
    ): Promise<AxiosResponse<MarginAccountDetailsResponse>>;
    marginOrder(
